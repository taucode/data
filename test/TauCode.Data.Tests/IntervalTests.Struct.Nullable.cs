...
[TestFixture]
public class IntervalTestsStructNullable
{
    [Test]
    ...
    {
        // Arrange
        var interval = new Interval<IntStruct?>(10, 20, true, true);
    ...
    public void CreateSingleValue_ArgumentIsNull_ThrowsArgumentNullException()
    {
        ...
        // Act
        var ex = Assert.Throws<ArgumentNullException>(() => Interval<IntStruct?>.CreateSingleValue(null));
