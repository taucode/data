...
[TestFixture]
public class ValueTypeIntervalTestsInt
{
    [Test]
    ...
    public void Ctor_AnyArgument_ReturnsExpectedResult(CtorTestDto testDto)
    {
        ...
        ValueTypeInterval<int> interval;

        // Act & Assert
        if (testDto.ExceptionException == null)
        {
            interval = new ValueTypeInterval<int>(
    ...
    public void CreateEmpty_NoArguments_CreatesEmptyInterval()
    {
        ...
        // Act
        var interval = ValueTypeInterval<int>.CreateEmpty();
    ...
    public void CreateSingleValue_ValidValue_CreatesSingleValueInterval()
    {
        ...
        // Act
        var interval = ValueTypeInterval<int>.CreateSingleValue(17);
    ...
    private static ValueTypeInterval<int> DtoToInterval(IntervalDto dto)
    {
        return new ValueTypeInterval<int>(
