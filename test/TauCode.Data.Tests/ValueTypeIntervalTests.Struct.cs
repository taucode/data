...
[TestFixture]
public class ValueTypeIntervalTestsStruct
{
    [Test]
    ...
    public void Ctor_AnyArgument_ReturnsExpectedResult(CtorTestDto testDto)
    {
        ...
        ValueTypeInterval<IntStruct> interval;

        // Act & Assert
        if (testDto.ExceptionException == null)
        {
            interval = new ValueTypeInterval<IntStruct>(
        ...
        else
        {
            ...
            Assert.That(ex.Message, Does.StartWith(testDto.ExceptionException.Message!.Replace(" and their value is not null", "")));
    ...
    public void CreateEmpty_NoArguments_CreatesEmptyInterval()
    {
        ...
        // Act
        var interval = ValueTypeInterval<IntStruct>.CreateEmpty();
    ...
    public void CreateSingleValue_ValidValue_CreatesSingleValueInterval()
    {
        ...
        // Act
        var interval = ValueTypeInterval<IntStruct>.CreateSingleValue(17);
    ...
    private static ValueTypeInterval<IntStruct> DtoToInterval(IntervalDto dto)
    {
        return new ValueTypeInterval<IntStruct>(
